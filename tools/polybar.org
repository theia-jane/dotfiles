#+TITLE: Polybar
#+PROPERTY: header-args :dir ${HOME}/.config/polybar :tangle config  :tangle-relative 'dir  :comments no

This was pulled from arco linux after modification to my liking. Could use cleanup and leveraging color variables (as well as breaking up into different src blocks here) 
#+begin_src conf
[global/wm]
...
modules-right = my-wm-num date battery 
